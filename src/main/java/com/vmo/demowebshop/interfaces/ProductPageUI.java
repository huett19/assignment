...
public class ProductPageUI {
    ...
    public static final String BOOK_PAGE = ("Demo Web Shop. Books");
    ...
    public static final String SHIPPING_ADDRESS_TAB = xpath("//li[@id='opc-shipping']");
    public static final String SHIPPING_ADDRESS_CONTINUE_BTN = xpath("//div[@id='checkout-step-shipping']//input[@value='Continue']");
    public static final String SHIPPING_METHOD_TAB = xpath("//li[@id='opc-shipping_method']");
    public static final String SHIPPING_METHOD_CONTINUE_BTN = xpath("//div[@id='shipping-method-buttons-container']//input[@value='Continue']");
